...
#
# NOTE: gcc6 does not require "CLOOG" anymore.
...
ASF_VERSION_SHORT=3.32.0
ASF_VERSION_LONG=${ASF_VERSION_SHORT}.48
...
ASF_ZIPFILE=asf-standalone-archive-${ASF_VERSION_LONG}.zip
